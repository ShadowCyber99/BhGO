...
const getStyles = (colors) => StyleSheet.create({
  ...
  helperHeader: { color: colors.text, fontSize: 14, fontWeight: '800', marginBottom: 12 },
  customRouteBox: { backgroundColor: colors.surface, padding: 16, borderRadius: 12, borderWidth: 1, borderColor: colors.overlayBorder, gap: 10, zIndex: 50 },
  routeInput: { backgroundColor: colors.surfaceLight, color: colors.text, fontSize: 15, fontWeight: '600', borderRadius: 8, paddingHorizontal: 16, paddingVertical: 14, borderWidth: 1, borderColor: colors.overlayBorder, marginBottom: 8 },
  suggestionsBox: { position: 'absolute', top: 60, left: 0, right: 0, backgroundColor: colors.surface, borderRadius: 8, borderWidth: 1, borderColor: colors.primary, maxHeight: 150, overflow: 'hidden', zIndex: 999 },
  ...
  routesWrapper: { flexDirection: 'column', gap: 10, marginBottom: 18 },
  routeCard: { backgroundColor: colors.surface, borderWidth: 1.5, borderColor: colors.overlayBorder, borderRadius: 10, paddingVertical: 16, paddingHorizontal: 16 },
  activeRouteCard: { borderColor: colors.primary, backgroundColor: 'rgba(249, 115, 22, 0.08)' },
  routeNameText: { color: colors.text, fontSize: 14, fontWeight: '700' },
  activeRouteNameText: { color: colors.primary },
  
  vehicleBtn: { paddingHorizontal: 12, paddingVertical: 10, borderRadius: 8, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.overlayBorder },
  vehicleBtnActive: { backgroundColor: 'rgba(249, 115, 22, 0.1)', borderColor: colors.primary },
  vehicleBtnText: { color: colors.textMuted, fontSize: 12, fontWeight: 'bold' },
